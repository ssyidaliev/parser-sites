...
import config
from lalafo_auto import run_lalafo_auto
from lalafo_household import run_lalafo_household
from lalafo_statements import run_lalafo_statements
from lalafo_tel import run_lalafo_tel
...
def run():
    ...
    for user_url in pars_url:
        parser.scrap_post(user_url, current_date)  # Парсим страницу
